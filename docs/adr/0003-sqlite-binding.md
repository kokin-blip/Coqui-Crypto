...
Phase 5 must run packaged Windows x64 and macOS arm64 smoke tests under the
selected Electron runtime. A packaged-build failure reopens this ADR; it does
not justify silently falling back to a second binding.
