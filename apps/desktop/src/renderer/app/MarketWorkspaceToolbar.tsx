...
export function MarketWorkspaceToolbar({ style, scaleMode, indicators, volumeVisible,
  ...
  return <div className="market-workspace-controls">
    ...
    <details className="chart-options-popover">
      <summary className="compact-control"><SlidersHorizontal size={14} /> Indicators{enabledCount > 0 ? ` · ${enabledCount}` : ''}<ChevronDown size={13} /></summary>
